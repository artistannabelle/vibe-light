...
📖 **产品介绍页**：[vibe-light.netlify.app](https://vibe-light.netlify.app)（若无法打开，以本页为准）
...
前往 **[Releases](https://github.com/artistannabelle/vibe-light/releases/latest)** 下载最新版：

`Vibe-Light-x.x-macOS.zip`
